...
export const LOOT_SPOTS: readonly LootSpotDef[] = [
  {
    ...
    z: -6.2,
    table: [
      { id: "food", min: 2, max: 6, chance: 0.95 },
      { id: "ammo", min: 8, max: 24, chance: 0.95 },
      { id: "scrap", min: 2, max: 6, chance: 0.7 },
      { id: "wood", min: 1, max: 4, chance: 0.45 },
      { id: "pistol", min: 1, max: 1, chance: 0.55 },
      { id: "knife", min: 1, max: 1, chance: 0.4 },
  ...
  },
  {
    ...
    z: -3.8,
    table: [
      { id: "scrap", min: 4, max: 12, chance: 0.98 },
      { id: "wood", min: 4, max: 10, chance: 0.95 },
      { id: "ammo", min: 4, max: 14, chance: 0.6 },
      { id: "axe", min: 1, max: 1, chance: 0.65 },
      { id: "food", min: 1, max: 3, chance: 0.4 },
      { id: "sword", min: 1, max: 1, chance: 0.2 },
  ...
  },
  {
    ...
    z: 9.2,
    table: [
      { id: "food", min: 2, max: 5, chance: 0.9 },
      { id: "scrap", min: 2, max: 7, chance: 0.75 },
      { id: "ammo", min: 4, max: 12, chance: 0.65 },
      { id: "medkit", min: 1, max: 2, chance: 0.45 },
      { id: "wood", min: 1, max: 4, chance: 0.5 },
      { id: "knife", min: 1, max: 1, chance: 0.35 },
      { id: "pistol", min: 1, max: 1, chance: 0.3 },
  ...
  },
  {
    ...
    z: 7.5,
    table: [
      { id: "medkit", min: 2, max: 4, chance: 0.95 },
      { id: "food", min: 2, max: 5, chance: 0.8 },
      { id: "ammo", min: 4, max: 10, chance: 0.5 },
      { id: "scrap", min: 1, max: 4, chance: 0.4 },
  ...
  },
  {
    ...
    z: -15.5,
    table: [
      { id: "wood", min: 3, max: 8, chance: 0.95 },
      { id: "scrap", min: 2, max: 6, chance: 0.9 },
      { id: "ammo", min: 2, max: 8, chance: 0.45 },
      { id: "food", min: 1, max: 3, chance: 0.4 },
  ...
  },
  {
    ...
    z: -12,
    table: [
      { id: "ammo", min: 12, max: 32, chance: 0.98 },
      { id: "pistol", min: 1, max: 1, chance: 0.75 },
      { id: "smg", min: 1, max: 1, chance: 0.55 },
      { id: "ar", min: 1, max: 1, chance: 0.35 },
      { id: "shotgun", min: 1, max: 1, chance: 0.2 },
      { id: "sword", min: 1, max: 1, chance: 0.3 },
      { id: "medkit", min: 1, max: 2, chance: 0.45 },
      { id: "food", min: 1, max: 3, chance: 0.35 },
      { id: "scrap", min: 2, max: 5, chance: 0.4 },
    ],
  },
];
